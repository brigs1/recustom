...
"""
_DESCRIPTION = """\
https://github.com/brigs1/recustom/
"""
...
class recustom(datasets.GeneratorBasedBuilder):
    ...
    def _info(self):
        return datasets.DatasetInfo(
            ...
            homepage="https://github.com/brigs1/recustom",
            citation=_CITATION,
        )

    def _split_generators(self, dl_manager):
        """Returns SplitGenerators."""
        downloaded_file = dl_manager.download_and_extract("/home/y/Documents/Jupyter_tests/datasets/recustom/dataset.zip")
        return [
